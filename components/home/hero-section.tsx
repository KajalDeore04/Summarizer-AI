...
export default function HeroSection() {
  return (
    <section className="relative mx-auto flex flex-col z-0 items-center justify-center py-16 sm:py-20 lg:pb-28 transition-all animate-in  lg:px-12 max-w-7xl ">
      <div className="relative p-[1px] overflow-hidden rounded-full bg-linear-to-r from-rose-200 via-rose-500 to-rose-800 animate-gradient-x group cursor-default">
        <Badge
          variant={"secondary"}
      ...
      <h1 className="font-bold py-6 text-center">
        ...
        <span className="relative inline-block">
          ...
          <span
            className="absolute inset-0 bg-rose-200/50 rounded-lg transform -skew-y-1 -rotate-2"
            aria-hidden="true"
          ></span>
        </span>{" "}
        summaries
